...
sum(fia.date < as.Date("2011/1/1"),na.rm=TRUE)/sum(!is.na(fia.date))*100
...
par(mfrow=c(1,1))
plot(doy,filter(ch4,rep(1/12,12)),type='l',main="CH4")
```
